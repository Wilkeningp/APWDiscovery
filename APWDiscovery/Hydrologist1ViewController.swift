//
//  Hydrologist1ViewController.swift
//  APWDiscovery
//
...
class Hydrologist1ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad();
        NotificationCenter.default.addObserver(self, selector: #selector(Hydrologist1ViewController.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(Hydrologist1ViewController.keyboardWillHide(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
   ...
   func keyboardWillShow(_ notification: Notification) {
    ...
    @IBAction func nextPage(_ sender: AnyObject) {
        ...
        if (qrCheck == "18679") {
            performSegue(withIdentifier: "toHyd2", sender: self);
        } else {
