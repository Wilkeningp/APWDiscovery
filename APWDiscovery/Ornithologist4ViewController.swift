//
//  Ornithologist4ViewController.swift
//  APWDiscovery
//
...
class Ornithologist4ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad();
        NotificationCenter.default.addObserver(self, selector: #selector(Ornithologist4ViewController.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(Ornithologist4ViewController.keyboardWillHide(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
    ...
    @IBAction func nextPage(_ sender: AnyObject) {
        ...
        if (qrCheck == "57310") {
            performSegue(withIdentifier: "toOrn5", sender: self);
        } else {
